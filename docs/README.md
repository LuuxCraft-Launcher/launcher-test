...
<h1 align="center">luuxcraft panel</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `LuuxCraft-Panel-win-x64.exe ` |
| macOS | `LuuxCraft-Panel-mac-universal.dmg` |
| Linux x64 | `LuuxCraft-Panel-linux-x86_64.AppImage` |
